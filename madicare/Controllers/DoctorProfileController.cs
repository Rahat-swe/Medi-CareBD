...
namespace madicare.Controllers
{
    public class DoctorProfileController : Controller
    {
        ...
        public DoctorProfileController(medicareDBContext context)
        {
            _context = context;
        }
